...
import (
	...
	"semp.dev/semp-reference-client/impl/go/internal/client"
	"semp.dev/semp-reference-client/impl/go/internal/config"
	"semp.dev/semp-reference-client/impl/go/internal/store"
)
